...
var orderProduct = models_1["default"].orderProduct;
...
var DashboardQueries = /** @class */ (function () {
    ...
    DashboardQueries.prototype.create = function (entry) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, orderProduct.create(entry)];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        products_in_orders = _a.sent();
                        return [2 /*return*/, products_in_orders];
                    case 2:
                        err_2 = _a.sent();
    ...
    DashboardQueries.prototype.productsInOneOrder = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var products_in_orders, Error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Order.findAll({ attributes: ['id'], where: { id: id },
                                include: {
