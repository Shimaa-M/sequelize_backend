...
var productStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Product.findOne({ where: { id: id } })];
                    case 1:
                        product = _a.sent();
    ...
    productStore.prototype.create = function (p, price) {
        return __awaiter(this, void 0, void 0, function () {
            var product, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Product.create({ name: p, price: price })];
                    case 1:
                        product = _a.sent();
                        return [2 /*return*/, product];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Product.update(p, { where: { id: p.id } })];
                    case 1:
                        product = _a.sent();
                        return [2 /*return*/, product];
                    case 2:
                        err_4 = _a.sent();
                        throw new Error("Could not update the product. Error: ".concat(err_4));
                    case 3:
                        ;
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Product.destroy({ where: { id: id } })];
                    case 1:
                        product = _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
