...
var orderStore = /** @class */ (function () {
    ...
    orderStore.prototype.create = function (status, user_id) {
        return __awaiter(this, void 0, void 0, function () {
            var order, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Order.create({ status: status, user_id: user_id })];
                    case 1:
                        order = _a.sent();
                        return [2 /*return*/, order];
                    case 2:
    ...
    orderStore.prototype.edit = function (o) {
        return __awaiter(this, void 0, void 0, function () {
            var order, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Order.update(o, { where: { id: o.id } })];
                    case 1:
                        order = _a.sent();
                        return [2 /*return*/, Order];
                    case 2:
                        err_4 = _a.sent();
                        throw new Error("Could not update the Order. Error: ".concat(err_4));
                    case 3:
                        ;
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Order.destroy({ where: { id: id } })];
                    case 1:
                        order = _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
