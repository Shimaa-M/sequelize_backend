...
var store = new orderController_1.orderStore();
...
var show = function (_req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, store.show(parseInt(_req.params.id))];
            case 1:
                order = _a.sent();
                if (order == null) {
                    return [2 /*return*/, next('order not found')];
                }
                res.json(order);
                return [3 /*break*/, 3];
            case 2:
...
var create = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user_id, status_1, neworder, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                console.log(user_id);
                status_1 = _req.body.status;
                return [4 /*yield*/, store.create(status_1, user_id)];
            case 1:
                neworder = _a.sent();
                res.json(neworder);
                return [3 /*break*/, 3];
...
var edit = function (_req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var user_id, order, updatedProduct, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                user_id = parseInt(res.locals.user_id);
            ...
            case 1:
                ...
                return [4 /*yield*/, store.edit(order)];
            case 2:
...
var destroy = function (_req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, store["delete"](parseInt(_req.params.id))];
            case 1:
                deleted = _a.sent();
                if (deleted == null) {
                    return [2 /*return*/, next('order not found')];
